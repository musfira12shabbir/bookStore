...
class _CateProductState extends State<CateProduct> {
  ...
  @override
  void initState() {
    userSearch.addListener(searchListner);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: widget.bookCate != "All" ? Text(widget.bookCate!) : const Text("Our Collection"),
      ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            StreamBuilder(stream: isSearch ? bookController.getSearchBook(searchQuery: userSearch.text) :  widget.bookCate != "All" ? bookController.getSpecificCateBooks(widget.bookCate) : bookController.getBooks(), builder: (context,AsyncSnapshot<List<BookModel>> snapshot) {
