...
class RegisterUpdate extends StatefulWidget {
  const RegisterUpdate({super.key,
  ...
  @override
  State<RegisterUpdate> createState() => _RegisterScreenState();
}

class _RegisterScreenState extends State<RegisterUpdate> {
  ...
  void initState() {
    ...
    userAge.text = widget.userAge;
    userAddress.text = widget.userAddress;
    userEmail.text = widget.userEmail;
    userPassword.text = widget.userPassword;
    super.initState();
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(onPressed: (){
                        ...
                        if(context.mounted){
                          kIsWeb ?  userRegisterLogin.userUpdate(UserModel(
                              userID: userID,
                          ...
                          ), context) :  userRegisterLogin.userUpdate(UserModel(
                              userID: userID,
                              userName: userName.text,
                              userAge: userAge.text,
                              userAddress: userAddress.text,
